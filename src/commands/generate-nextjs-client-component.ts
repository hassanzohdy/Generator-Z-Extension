...
import {
  NextClientComponentOptions,
  generateNextClientReactComponent as generateComponentApi,
  gnz,
} from "@mongez/gnz";
...
export function generateNextjsClientComponent(
  defaultOptions: Partial<NextClientComponentOptions> = {
    memo: false,
    forwardRef: false,
  }
) {
